...
const OurNews = () => {
    ...
    return (
        <div className='flex justify-center px-0 lg:px-16 mb-10'>
            <div >
                <h1 className='text-center w text-[#011F48] font-bold lg:text-5xl text-2xl lg:mt-5 lg:mb-20 mt-3 uppercase'>OUR LATEST NEWS</h1>
                <div className='grid grid-cols-1 lg:grid-cols-3 gap-x-16 gap-y-5 mt-10'>
                    <div
                        data-aos="zoom-in-right"
                        data-aos-easing="linear"
                        data-aos-delay="500"
                        data-aos-duration="5000">
                        <img className='w-80 lg:w-full' src={news1} alt="" />

                        <div className='flex justify-center '>
                            <div className='w-80 lg:w-full'>
                                <h3 className='font-semibold my-2'>We Bring you the best</h3>
                                <div className='flex justify-center items-center w-80 lg:w-full'>
                    ...
                    >
                        <img className='w-80 lg:w-full' src={news2} alt="" />
                        <p></p>
                        <div className='flex justify-center'>
                            <div className='w-80 lg:w-full'>
                    ...
                    <div
                        ...
                        data-aos-delay="700"
                        data-aos-duration="5000">
                        <img className='w-80 lg:w-full' src={news3} alt="" />
